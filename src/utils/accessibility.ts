/**
 * Accessibility utilities for EU Accessibility Act compliance
 * Based on EN 301 549 and WCAG 2.1 Level AA standards
 */
 ...
 */
export const getAriaLabel = (label: string, context?: string): string => {
