      ...
      <div className="flex flex-row <md:flex-col-reverse">
        <div className="flex flex-col space-y-8">
          <div className="flex flex-col space-y-2">
            ...
            <p>
              {" "}
              I have been always, looking into the future, wanting to create new
              solutions using technology to change how we live our everyday
              lives. My mission is to innovate, while also make my work to be
              understood by others and be able to work together with people.
              Creativity, my pursuit after my goals and my determination are my
              main attributes. I always try my best to understand the needs of
              people I work with, and find a way for all parties to be happy.
            </p>
          </div>
          <div className="flex flex-col space-y-2">
        ...
        <div className="flex flex-col pb-4 flex-shrink-0 >md:self-start >md:sticky >md:top-16 <md:w-full items-center">
          ...
          <div className="w-full self-center">
            <h4 className="text-center pt-2 <md:w-full <md:self-center">
              Daniel Richard Aboo
            </h4>
            <h5 className="text-center pt-2 <md:w-full <md:self-center">
              Full-stack Developer, Prompt Engineer
            </h5>
            <p className="w-full pt-2 <md:text-center">
